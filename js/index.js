...
const I18N = {
  en: {
    ...
    'app.title':'App','app.name':'Phrame — an app for making your own English phrase notes.','app.desc':'Instantly search and save the phrases you want to remember, then review them anytime — an app built for learning English phrases.','app.cta':'About the app',
  ...
  jp: {
    ...
    'app.title':'アプリ','app.name':'Phrame — 自分だけの英語フレーズ帳を作るアプリ。','app.desc':'覚えたいフレーズをすぐに検索・保存して、いつでも見返せる「英語フレーズ学習特化」のアプリです。','app.cta':'アプリついて',
  ...
  es: {
    ...
    'app.title':'App','app.name':'Phrame — una app para crear tus propias notas de frases en inglés.','app.desc':'Busca y guarda al instante las frases que quieras recordar, y repásalas cuando quieras — una app especializada en aprender frases en inglés.','app.cta':'Sobre la app',
