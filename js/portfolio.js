...
const I18N = {
  en: {
    ...
    'app.section.compare':'Why Phrame?',
    'app.compare.sub':'How Phrame is different from what you already use.',
  ...
  es: {
    ...
    'app.section.compare':'Why Phrame?',
    'app.compare.sub':'En qué se diferencia Phrame de lo que ya usas.',
